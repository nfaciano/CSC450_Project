#ifndef CSC450LIB_LINALG_OPTIMIZER1D_GSS_H
#define CSC450LIB_LINALG_OPTIMIZER1D_GSS_H
...
/**
 * @class Optimizer1D_gss
 * @brief A class that performs optimization using the golden-section search method.
 */
...
public:
    ...
    /**
     * @brief Performs minimization using the golden-section search method.
     * 
...
#endif // CSC450LIB_LINALG_OPTIMIZER1D_GSS_H
